...
from inspect_ai.model import GenerateConfig, Model, CachePolicy
...
# USER_PROMPT_TEMPLATE = """
# Solve the following problem. The last line of your response should be of the form "ANSWER: $ANSWER" (without quotes) where $ANSWER is the answer to the problem.
#
# {prompt}
#
...
# {prompt}
#
# Remember to put your answer on its own line at the end in the form "ANSWER: $ANSWER" (without quotes) where $ANSWER is the answer to the problem. First think step by step before outputting your answer.
# """.strip()
...
def math_solver(
    ...
    """
    solver = [prompt_template(USER_PROMPT_TEMPLATE), generate(cache=CachePolicy("1M"))]
